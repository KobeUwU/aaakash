...
jQuery(document).ready(function() {
    ...
    jQuery(".tf-v1-popover-button:not(.open .tf-v1-popover-button), .tbdemo-circle-icon:not(.tbdemo-close-circle)").hover(function() {
            if (jQuery(".tf-v1-popover.open").length) {
                return;
            }
            let cont = jQuery("<div>", {
            ...
            cont.css({
                "bottom": 22 + 81 * (item_count - 1 - index) + 15
            });
