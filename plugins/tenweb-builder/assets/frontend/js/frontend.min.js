    ...
    var e = elementorModules.frontend.handlers.Base.extend({
        ...
        singleLetters: function() {
            ...
            this.elements.$dynamicText.each((function() {
                ...
                t.empty(), i.forEach((function(i) {
                    ...
                    s && n.addClass(e.animationIn), t.append(n)
                })), t.css("opacity", 1)
            }))
        },
        showLetter: function(e, t, i, s) {
            var n = this,
                o = this.getSettings("classes");
            e.addClass(o.animationIn), e.is(":last-child") ? i || setTimeout((function() {
                n.hideWord(t)
            }), n.getSettings("animationDelay")) : setTimeout((function() {
                n.showLetter(e.next(), t, i, s)
            }), s)
        },
        hideLetter: function(e, t, i, s) {
            var n = this,
                o = this.getSettings();
            e.removeClass(o.classes.animationIn), e.is(":last-child") ? i && setTimeout((function() {
                n.hideWord(n.getNextWord(t))
            }), n.getSettings("animationDelay")) : setTimeout((function() {
                n.hideLetter(e.next(), t, i, s)
            }), s)
        },
        showWord: function(e, t) {
            var i = this,
                s = i.getSettings(),
                n = i.getElementSettings("animation_type");
            "typing" === n ? (i.showLetter(e.find("." + s.classes.dynamicLetter).eq(0), e, !1, t), e.addClass(s.classes.textActive).removeClass(s.classes.textInactive)) : "clip" === n && i.elements.$dynamicWrapper.animate({
                width: e.width() + 10
        ...
        hideWord: function(e) {
            ...
            if ("typing" === o) t.elements.$dynamicWrapper.addClass(s.typeSelected), setTimeout((function() {
                t.elements.$dynamicWrapper.removeClass(s.typeSelected), e.addClass(i.classes.textInactive).removeClass(s.textActive).children(n).removeClass(s.animationIn)
            }), i.selectionDuration), setTimeout((function() {
                t.showWord(r, i.typeLettersDelay)
            }), i.typeAnimationDelay);
            else if (t.elements.$headline.hasClass(s.letters)) {
                var a = e.children(n).length >= r.children(n).length;
                t.hideLetter(e.find(n).eq(0), e, a, i.lettersDelay), t.showLetter(r.find(n).eq(0), r, a, i.lettersDelay)
        ...
        fillWords: function() {
            ...
            if ("rotate" === e.headline_style) {
                (e.rotating_text || "").split("\n").forEach((function(e, s) {
                    ...
                    s || n.addClass(t.textActive), i.append(n)
                }))
            } else {
                var s = jQuery("<span>", {
                ...
                i.append(s, n[0].outerHTML)
            }
            this.elements.$dynamicText = i.children("." + t.dynamicText)
        },
...
var tenwebCountdown = function(e, t) {
    var i, s = {
        ...
        n = function() {
            var n = tenwebCountdown.getTimeRemaining(t, s.$monthsSpan.length);
            (jQuery.each(n.parts, (function(e) {
                var t = s["$" + e + "Span"],
                    i = this.toString();
                1 === i.length && (i = 0 + i), t.length && t.text(i)
            })), n.total <= 0) && ("yes" == e.data("hide-after-expiry") && (e.find(".tenweb-countdown-item").addClass("tenweb-hidden"), e.parent().find(".tenweb-countdown-description").addClass("tenweb-hidden"), e.parent().find(".tenweb-countdown-expired").removeClass("tenweb-hidden")), clearInterval(i))
        };
    n(), i = setInterval(n, 1e3)
};
tenwebCountdown.getTimeRemaining = function(e, t) {
        var i = new Date,
            s = e - i,
            n = Math.floor(s / 864e5),
            o = t && n > 31 ? 12 * (e.getFullYear() - i.getFullYear()) + e.getMonth() - i.getMonth() : 0;
        t && o && (n = e.getDate() - i.getDate());
        var r = Math.floor(s / 36e5 % 24),
            a = Math.floor(s / 1e3 / 60 % 60),
            l = Math.floor(s / 1e3 % 60);
        return (n < 0 || r < 0 || a < 0) && (l = a = r = n = 0), {
            total: s,
            parts: {
                months: o,
                days: n,
        ...
        elementorFrontend.hooks.addAction("frontend/element_ready/twbbcountdown.default", (function(e) {
            var t = e.find(".tenweb-countdown"),
                i = new Date(1e3 * t.data("date"));
            new tenwebCountdown(t, i)
        }))
    })), jQuery(window).on("elementor/frontend/init", (function() {
        ...
        function t(t) {
            ...
            e.isLoaded ? i() : jQuery(document).on("fb:sdk:loaded", i)
        }
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            onHotspotTriggerEvent: function(e) {
                const t = jQuery(e.target),
                    i = t.closest(".e-hotspot__button").length,
                ...
                if (!(t.closest(".e-hotspot--link").length && n && ("mouseleave" === e.type || "mouseenter" === e.type)) && (i || s)) {
            ...
            hotspotSequencedAnimation: function() {
                ...
                const t = elementorModules.utils.Scroll.scrollObserver({
                    callback: i => {
                        i.isInViewport && (t.unobserve(this.$element[0]), this.elements.$hotspot.each(((t, i) => {
                            if (0 === t) return;
                            const s = e.hotspot_sequenced_animation_duration,
                                n = t * ((s ? s.size : 1e3) / this.elements.$hotspot.length);
                            i.style.animationDelay = n + "ms"
                        })))
                    }
                });
                    ...
                    ["mousemove", function(e) {
                        ...
                        if (s) {
                            var n = Math.abs(s.x - t.x),
                                o = Math.abs(s.y - t.y);
                            if ((n > 0 || o > 0) && n <= 2 && o <= 2 && t.timeStamp - s.timeStamp <= 300 && (mouse = !0, i)) {
            ...
            prototype: {
                init: function(e) {
                    ...
                    if (this.$firstSub = this.$root.find("ul").each((function() {
                        ...
                        var s = /(index|default)\.[^#\?\/]*/i,
                            n = window.location.href.replace(s, ""),
                            o = n.replace(/#.*/, "");
                        this.$root.find("a").each((function() {
                            var e = this.href.replace(s, ""),
                                i = $(this);
                            e != n && e != o || (i.addClass("current"), t.opts.markCurrentTree && i.parentsUntil("[data-smartmenus-id]", "ul").each((function() {
                ...
                getOffset: function(e, t) {
                    ...
                    var s = e[0].getBoundingClientRect && e[0].getBoundingClientRect(),
                        n = s && (t ? s.height || s.bottom - s.top : s.width || s.right - s.left);
                    return n || 0 === n || (n = t ? e[0].offsetHeight : e[0].offsetWidth), i && e.hide().css(i), n
                },
                ...
                itemActivate: function(e, t) {
                    ...
                    if (s > 1 && (!this.activatedItems[s - 2] || this.activatedItems[s - 2][0] != i.dataSM("parent-a")[0])) {
                        ...
                        $(i.parentsUntil("[data-smartmenus-id]", "ul").get().reverse()).add(i).each((function() {
                            n.itemActivate($(this).dataSM("parent-a"))
                        }))
                    }
                ...
                itemClick: function(e) {
                    ...
                    if (this.handleItemEvents(t)) {
                        ...
                        var i = $(e.target).is("span.sub-arrow"),
                            s = t.dataSM("sub"),
                            n = !!s && 2 == s.dataSM("level");
                        if (s && !s.is(":visible")) {
                            if (this.opts.showOnClick && n && (this.clickActivated = !0), this.itemActivate(t), s.is(":visible")) return this.focusActivated = !0, !1
                        } else if (this.isCollapsible() && i) return this.itemActivate(t), this.menuHide(s), !1;
                        return !(this.opts.showOnClick && n || t.hasClass("disabled") || !1 === this.$root.triggerHandler("select.smapi", t[0])) && void 0
                    }
                },
                itemDown: function(e) {
                    var t = $(e.currentTarget);
                ...
                menuPosition: function(e) {
                    ...
                    if (v ? (t = y ? u - a - _ : _, i = this.opts.bottomToTopSubMenus ? -l - S : m + S) : (t = y ? _ - a : u - _, i = this.opts.bottomToTopSubMenus ? m - S - l : S), this.opts.keepInViewport) {
                        var C = d + t,
                            k = h + i;
                        if (y && C < g ? t = v ? g - C + t : u - _ : !y && C + a > g + b && (t = v ? g + b - a - C + t : _ - a), v || (l < w && k + l > f + w ? i += f + w - l - k : (l >= w || k < f) && (i += f - k)), v && (k + l > f + w + .49 || k < f) || !v && l > w + .49) {
                            var I = this;
                ...
                menuScroll: function(e, t, i) {
                    var s, n = e.dataSM("scroll"),
                        o = e.dataSM("scroll-arrows"),
                        r = n.up ? n.upEnd : n.downEnd;
                    if (!t && n.momentum) {
                        if (n.momentum *= .92, (s = n.momentum) < .5) return void this.menuScrollStop(e)
                    } else s = i || (t || !this.opts.scrollAccelerate ? this.opts.scrollStep : Math.floor(n.step));
                    var a = e.dataSM("level");
                    if (this.activatedItems[a - 1] && this.activatedItems[a - 1].dataSM("sub") && this.activatedItems[a - 1].dataSM("sub").is(":visible") && this.menuHideSubMenus(a - 1), n.y = n.up && r <= n.y || !n.up && r >= n.y ? n.y : Math.abs(r - n.y) > s ? n.y + (n.up ? s : -s) : r, e.add(e.dataSM("ie-shim")).css(this.cssTransforms3d ? {
                            "-webkit-transform": "translate3d(0, " + n.y + "px, 0)",
                            transform: "translate3d(0, " + n.y + "px, 0)"
                        } : {
                            marginTop: n.y
                        }), mouse && (n.up && n.y > n.downEnd || !n.up && n.y < n.upEnd) && o.eq(n.up ? 1 : 0).show(), n.y == r) mouse && o.eq(n.up ? 0 : 1).hide(), this.menuScrollStop(e);
                    else if (!t) {
                        this.opts.scrollAccelerate && n.step < this.opts.scrollStep && (n.step += .2);
                        var l = this;
                ...
                menuScrollOver: function(e, t) {
                    if (mouse && !/^scroll-(up|down)/.test(t.target.className) && this.getClosestMenu(t.target) == e[0]) {
                        ...
                        var i = e.dataSM("scroll"),
                            s = $(window).scrollTop() - e.dataSM("parent-a").offset().top - i.itemH;
                        e.dataSM("scroll-arrows").eq(0).css("margin-top", s).end().eq(1).css("margin-top", s + this.getViewportHeight() - i.arrowDownH).end().css("visibility", "visible")
                    }
                },
                    ...
                    if (isTouchEvent(t = t.originalEvent)) {
                        ...
                        if (this.getClosestMenu(i.target) == e[0]) {
                            ...
                            if (/(start|down)$/i.test(t.type)) this.menuScrollStop(e) ? (t.preventDefault(), this.$touchScrollingSub = e) : this.$touchScrollingSub = null, this.menuScrollRefreshData(e), $.extend(s, {
                                ...
                                var n = void 0 !== s.touchY ? s.touchY : s.touchStartY;
                                if (void 0 !== n && n != i.pageY) {
                                    ...
                                    void 0 !== s.up && s.up != o && $.extend(s, {
                                        ...
                                        up: o,
                                        touchY: i.pageY
                                    }), this.menuScroll(e, !0, Math.abs(i.pageY - n))
                                }
                                t.preventDefault()
                            } else void 0 !== s.touchY && ((s.momentum = 15 * Math.pow(Math.abs(i.pageY - s.touchStartY) / (t.timeStamp - s.touchStartTime), 2)) && (this.menuScrollStop(e), this.menuScroll(e), t.preventDefault()), delete s.touchY)
                        }
                    }
                },
                menuShow: function(e) {
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            toggleMenu: function(e) {
                var t = this.elements.$dropdownMenu,
                    i = this.elements.$menuToggle.hasClass("twbb-active");
                "boolean" != typeof e && (e = !i), this.elements.$menuToggle.toggleClass("twbb-active", e), e ? (t.hide().slideDown(250, (function() {
                    t.css("display", "")
            ...
            onInit: function() {
                jQuery("body").hasClass("elementor-editor-active") && (jQuery(".ai-recreated-menu-item").parent().css("gap", "3px"), jQuery(".ai-recreated-menu-item").each((function() {
                    ...
                    let t, i, s, n, o, r, a, l;
                    t = jQuery(this).closest("ul").attr("class"), i = jQuery(this).closest("li").attr("class"), s = new RegExp("twbb-menu_term_id-\\s*(\\d+)"), n = new RegExp("menu-item-\\s*(\\d+)"), o = new RegExp("twbb_menu_order_\\s*(\\d+)"), r = t.match(s), a = i.match(n), l = i.match(o), r && a && l && window.open(twbb.tenweb_dashboard + "/websites/" + twbb.dashboard_website_id + "/ai-builder?add_page=1&menu_term_id=" + r[1] + "&menu_item_id=" + a[1] + "&menu_item_position=" + l[1], "_blank")
...
var twbb_widgets = [],
    twbb_posts = function(e, t) {
        ...
        this.query_args = e.query_args, this.query_args_hash = e.query_args_hash, this.widget_id = e.widget_id, this.settings = e.settings, this.posts = [], this.pages_count = 1, this.init = function() {
            ! function() {
                0 == (o = jQuery('div[data-id="' + i.widget_id + '"]')).length && (o = jQuery(".elementor-global-" + i.widget_id));
            ...
            function() {
                ...
                "above_title" === settings.image_position ? n += e + t : n += t + e;
                if (void 0 !== settings.meta_data && settings.meta_data.length > 0) {
                    n += "<div class='twbb-posts-meta-data'>";
                    for (var s = 0; s < settings.meta_data.length; s++) {
                        switch (settings.meta_data[s]) {
                            case "author":
                                n += '<span class="twbb-posts-author-meta"><% print(posts_print_author(twbb_author)) %></span>';
                                break;
                            case "date":
                                n += '<span class="twbb-posts-date-meta"><%= twbb_date %></span>';
                                break;
                            case "time":
                                n += '<span class="twbb-posts-time-meta"><%= twbb_time %></span>';
                                break;
                            case "comments":
                                n += '<span class="twbb-posts-comments-meta"><% if(twbb_comments > 0) { %><%=  twbb_comments %> <% }else{ print("No") } print(" comments")%></span>';
                                break;
                            case "categories":
                                n += '<span class="twbb-posts-categories-meta"><% print(posts_print_terms(twbb_categories, "categories")) %></span>';
                                break;
                            case "tags":
                                n += '<span class="twbb-posts-tags-meta"><% print(posts_print_terms(twbb_tags, "tags")) %></span>'
                        }
                        n += '<span class="twbb-posts-meta-separator">' + settings.meta_separator + "</span>"
                    }
                    n += "</div>"
                }
                "yes" === settings.show_excerpt && (n += "<div class='twbb-posts-content'><%= twbb_excerpt %></div>");
                "yes" === settings.show_read_more && (n += "<div class='twbb-posts-read-more'><a href='<%= twbb_permalink %>'>" + settings.read_more_text + "</a></div>");
                n = '<div class="twbb-posts-item">' + n + "</div>"
            }(), this.get_posts()
            ...
            for (t in this.posts) e = i(this.posts[t]), a.append(e);
            ...
            if (this.show_loading(), 1 === s && void 0 !== e.first_page_data) return i.posts = e.first_page_data.posts, i.pages_count = e.first_page_data.pages_count, i.render(), void i.hide_loading();
            jQuery.post(twbb.ajaxurl, {
                action: "twbb_widgets",
                widget_name: "posts",
                query_args: i.query_args,
                query_args_hash: i.query_args_hash,
                page: s,
                nonce: twbb.nonce
            }).done((function(e) {
                i.posts = e.data.posts, i.pages_count = parseInt(e.data.pages_count), i.render(), i.hide_loading()
            })).fail((function(e) {
                i.hide_loading()
            }))
            ...
            var e = a.imagesLoaded((function() {
                e.masonry({
                    gutter: i.settings.masonry_column_gap.size,
            ...
            var e = "",
                ...
                n = "";
            "yes" === this.settings.pagination_first_last_buttons && (n = "twbb-posts-page twbb-posts-page-first", 1 === s && (n += " " + t), e += get_page_link_html(n, 1, this.settings.pagination_first_label)), "yes" === this.settings.pagination_next_prev_buttons && (n = "twbb-posts-page twbb-posts-page-prev", 1 === s && (n += " " + t), e += get_page_link_html(n, s - 1, this.settings.pagination_prev_label));
            ...
            if ("yes" === this.settings.pagination_number_buttons)
                for (var d = 1; d <= l; d++) n = "twbb-posts-page twbb-posts-page-num", d === s && (n += " twbb-posts-current-page " + t), e += get_page_link_html(n, d, d);
            "yes" === this.settings.pagination_next_prev_buttons && (n = "twbb-posts-page twbb-posts-page-next", s === this.pages_count && (n += " " + t), e += get_page_link_html(n, s + 1, this.settings.pagination_next_label)), "yes" === this.settings.pagination_first_last_buttons && (n = "twbb-posts-page twbb-posts-page-last", s === this.pages_count && (n += " " + t), e += get_page_link_html(n, l, this.settings.pagination_last_label)), null === r ? (e = "yes" === this.settings.pagination_scroll_top ? "<div class='twbb-posts-pagination twbb-pagination_scroll_top'>" + e + "</div>" : "<div class='twbb-posts-pagination'>" + e + "</div>", a.parent().append(e), r = o.find(".twbb-posts-pagination")) : r.append(e), r.find(".twbb-posts-page").on("click", (function(e) {
                ...
                return t < 1 || t > i.pages_count || (s = t, i.get_posts(), jQuery(this).parent().hasClass("twbb-pagination_scroll_top") && jQuery(window).scrollTop(0)), !1
            }))
            ...
            l.hide()
        }, get_page_link_html = function(e, t, i) {
            return "<a href='#' class='" + e + "' data-page='" + t + "'>" + i + "</a>"
        }, posts_print_author = function(e) {
            return "yes" === i.settings.author_meta_link ? "<a href='" + e.link + "'>" + e.name + "</a>" : e.name
        }, posts_print_terms = function(e, t) {
            var s = "",
                n = "tags" === t ? "#" : "",
                o = "categories" === t && "yes" === i.settings.categories_meta_link || "tags" === t && "yes" === i.settings.tags_meta_link;
            for (var r in e) s += !0 === o ? "<a href='" + e[r].link + "'>" + n + e[r].name + "</a>, " : n + e[r].name + ", ";
            return s.trim().slice(0, s.length - 2)
        }, this.clear_html = function() {
            null !== a && a.html(""), null !== r && (r.html(""), "yes" === i.settings.masonry && a.masonry("destroy"))
    ...
    function(e) {
        var t = function(i, s) {
                ...
                r = function(e) {
                    ...
                    if (o.width && o.height) {
                        var s = screen.width / 2 - o.width / 2,
                            n = screen.height / 2 - o.height / 2;
                        i = "toolbar=0,status=0,width=" + o.width + ",height=" + o.height + ",top=" + n + ",left=" + s
                    }
                    var r = function(e) {
                            var i = t.networkTemplates[e].replace(/{([^}]+)}/g, (function(t, i) {
                                if ("twitter" == e && "text" == i) {
                                    var s = jQuery(jQuery.parseHTML(o[i])).text().replace(/\s\s+/g, " "),
                                        n = window.location.href;
                                    o[i] = s.substr(0, 345 - n.length) + " ..."
                                }
                                return o[i]
                            }));
                            return encodeURI(i)
            ...
            e.extend(o, t.defaultSettings, s), ["title", "text"].forEach((function(e) {
                o[e] = o[e].replace("#", "")
            })), o.classPrefixLength = o.classPrefix.length, n = e(i), a()
        };
        t.networkTemplates = {
        ...
        e = t.extend({
            onInit: function() {
                ...
                s ? n.url = e.share_url.url : (n.url = location.href, n.title = elementorFrontend.config.post.title, n.text = elementorFrontend.config.post.excerpt), this.elements.$shareButton.shareLink(n)
            },
            getDefaultSettings: function() {
                return {
                    selectors: {
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            getContainer: function() {
                ...
                var i = this.$element.parents(".elementor");
                return "popup" === i.attr("data-elementor-type") ? i : jQuery(e.selectors.postContentContainer)
            },
            bindEvents: function() {
                var e = this,
                    t = this.getElementSettings();
            ...
            getHeadings: function() {
                ...
                return this.elements.$pageContainer.find(t).not(i.headerTitle).filter((function(e, t) {
            ...
            addAnchorsBeforeHeadings: function() {
                var e = this,
                    t = this.getSettings("classes");
                this.elements.$headings.before((function(i) {
                    if (!jQuery(e.elements.$headings[i]).data("hasOwnID")) return '<span id="'.concat(t.headingAnchor, "-").concat(i, '" class="').concat(t.anchor, ' "></span>')
                }))
            },
            activateItem: function(e) {
                var t, i = this.getSettings("classes");
                (this.deactivateActiveItem(e), e.addClass(i.activeItem), this.$activeItem = e, this.getElementSettings("collapse_subitems")) && ((t = e.hasClass(i.firstLevelListItem) ? e.parent().next() : e.parents("." + i.listWrapper).eq(-2)).length ? (this.$activeList = t, this.$activeList.stop().slideDown()) : delete this.$activeList)
            },
            ...
            followAnchor: function(e, t) {
                var i, s = this,
                    n = e[0].hash;
                try {
                    i = jQuery(decodeURIComponent(n))
                } catch (e) {
                    return
                }
                elementorFrontend.waypoint(i, (function(n) {
                    if (!s.itemClicked) {
                        var o = i.attr("id");
                        "down" === n ? (s.viewportItems[o] = !0, s.activateItem(e)) : (delete s.viewportItems[o], s.activateItem(s.$listItemTexts.eq(t - 1)))
                    }
                }), {
                    ...
                    if (!s.itemClicked) {
                        var o = i.attr("id");
                        "down" === n ? (delete s.viewportItems[o], s.viewportItems.length && s.activateItem(s.$listItemTexts.eq(t + 1))) : (s.viewportItems[o] = !0, s.activateItem(e))
                    }
                }), {
                    offset: 0,
                    triggerOnce: !1
            ...
            followAnchors: function() {
                var e = this;
                this.$listItemTexts.each((function(t, i) {
                    return e.followAnchor(jQuery(i), t)
                }))
            },
            ...
            createNestedList: function() {
                var e = this;
                this.headingsData.forEach((function(t, i) {
                    t.level = 0;
                    for (var s = i - 1; s >= 0; s--) {
                        var n = e.headingsData[s];
                        if (n.tag <= t.tag) {
            ...
            getNestedLevel: function(e) {
                for (var t = this.getSettings(), i = this.getElementSettings(), s = this.getElementSettings("icon"), n = "<".concat(t.listWrapperTag, ' class="').concat(t.classes.listWrapper, '">'); this.listItemPointer < this.headingsData.length;) {
                    ...
                    if (e === o.level) {
                        n += '<li class="'.concat(t.classes.listItem, '">'), n += '<div class="'.concat(t.classes.listTextWrapper, '">');
                        var a = '<a href="#'.concat(o.anchorLink, '" class="').concat(r, '">').concat(o.text, "</a>");
                        "bullets" === i.marker_view && s && (a = '<i class="'.concat(s.value, '"></i>').concat(a)), n += a, n += "</div>", this.listItemPointer++;
                        var l = this.headingsData[this.listItemPointer];
                        l && e < l.level && (n += this.getNestedLevel(l.level)), n += "</li>"
                    }
                }
                return n += "</".concat(t.listWrapperTag, ">")
            },
            ...
            getHeadingAnchorLink: function(e, t) {
                var i = this.elements.$headings[e].id,
                    s = this.elements.$headings[e].closest(".elementor-widget").id,
                    n = "";
                return i ? n = i : s && (n = s), i || s ? jQuery(this.elements.$headings[e]).data("hasOwnID", !0) : n = "".concat(t.headingAnchor, "-").concat(e), n
            },
            setHeadingsData: function() {
                var e = this;
                this.headingsData = [];
                var t = this.getSettings("classes");
                this.elements.$headings.each((function(i, s) {
                    var n = e.getHeadingAnchorLink(i, t);
                    e.headingsData.push({
            ...
            onListItemClick: function(e) {
                ...
                var i, s = jQuery(e.target),
                    n = s.parent().next(),
                    o = this.getElementSettings("collapse_subitems");
                o && s.hasClass(this.getSettings("classes.firstLevelListItem")) && n.is(":visible") && (i = !0), this.activateItem(s), o && i && n.slideUp()
            }
        });
...
class TWBB_WooCommerce_Base extends elementorModules.frontend.handlers.Base {
    ...
    activateStickyRightColumn() {
        ...
        t.length && "fixed" === t.css("position") && (s += t.height()), "yes" === this.getElementSettings("sticky_right_column") && (this.elements.$stickyRightColumn.addClass(i.stickyRightColumnActive), this.elements.$stickyRightColumn.css("top", s + "px"))
    }
    ...
    updateWpReferers() {
        const e = this.getSettings("selectors"),
            ...
            i = new URL(document.location);
        i.searchParams.set("elementorPageId", elementorFrontend.config.post.id), i.searchParams.set("elementorWidgetId", this.getID()), t.attr("value", i)
    }
}
jQuery(window).on("elementor/frontend/init", (function() {
        var e = elementorModules.frontend.handlers.Base.extend({
                ...
                updateSpaceBetween: function(e, t) {
                    ...
                    if ("desktop" !== s) {
                        ...
                        e.params.breakpoints[r[s]].spaceBetween = n
                    } else e.originalParams.spaceBetween = n;
                    e.params.spaceBetween = n, e.update()
                },
                async onInit() {
            ...
            t = e.extend({
                ...
                getDefaultElements: function() {
                    var t = this.getSettings("selectors"),
                        i = e.prototype.getDefaultElements.apply(this, arguments);
    ...
    function(e, t) {
        tenwebParallax = function(i, s) {
            ...
            var o = {};
            ! function(e) {
                o = n, "object" != typeof e && (o = n);
                let t = Object.entries(e);
                for (let e = 0; e < t.length; e++) "object" == typeof t[e] && "object" == typeof n[t[e][0]] && "object" == typeof t[e][1] && (void 0 !== t[e][1].active && ["on", "yes", "On", "Yes", !0].includes(t[e][1].active) && (o[t[e][0]].active = !0), void 0 !== t[e][1].speed && 0 <= t[e][1].speed <= 10 && (o[t[e][0]].speed = t[e][1].speed), void 0 !== t[e][1].direction && ["in", "out", "up", "down"].includes(t[e][1].direction) && (o[t[e][0]].direction = t[e][1].direction))
            }(s), this.layerDiv = function() {
                var s = e.createElement("div");
                s.classList.add("tenweb-elementor-scrolling-effects-container");
                var n = e.createElement("div");
                n.classList.add("tenweb-elementor-scrolling-effects-layer");
                var o = i.currentStyle || t.getComputedStyle(i, null);
                return n.style.backgroundImage = o.backgroundImage, n.style.backgroundPosition = o.backgroundPosition, n.style.backgroundRepeat = o.backgroundRepeat, n.style.backgroundSize = o.backgroundSize, s.appendChild(n), i.prepend(s), n
            }(), this.options = o
                ...
                if (this.options.vertical_scroll.active) {
                    if (this.layerDiv.style.height = 100 + 100 * this.options.vertical_scroll.speed / 10 + "%", this.isElementVisible()) {
                        var e = this.element.offsetHeight * this.options.vertical_scroll.speed / 2 / 10,
                            i = -(t.scrollY + t.innerHeight - this.element.offsetTop) * this.options.vertical_scroll.speed / 4 / 10;
                        return "down" == this.options.vertical_scroll.direction && (i = -i), "translateY(calc(-" + e + "px + " + i + "px))"
                    }
                    return ""
                }
                return ""
                ...
                if (this.options.horizontal_scroll.active) {
                    if (this.layerDiv.style.width = 100 + 100 * this.options.horizontal_scroll.speed / 10 + "%", this.isElementVisible()) {
                        var e = (t.scrollY + t.innerHeight - this.element.offsetTop) * this.options.horizontal_scroll.speed / 4 / 10,
                            i = this.element.offsetWidth * this.options.horizontal_scroll.speed / 2 / 10;
                        return "left" == this.options.horizontal_scroll.direction && (e = -e), "translateX(calc(-" + i + "px + " + e + "px))"
                    }
                    return ""
                }
                return ""
            ...
            isElementVisible: function() {
                ...
                return i.top + i.height >= 0 && i.top <= (t.innerHeight || e.documentElement.clientHeight)
            },
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            updateSettings: function(e) {
                var t = this;
                for (const [i, s] of Object.entries(t.defoult_settings)) void 0 !== e[i] ? t.current_settings[i] = e[i] : t.current_settings[i] = t.defoult_settings[i]
            },
            ...
            run: function(e) {
                ...
                if (this.isSectionParallax(t))
                    if (this.updateSettings(t), "yes" === this.current_settings.tenweb_enable_parallax_efects && "classic" === this.current_settings.background_background) {
                        var i = elementorFrontend.getCurrentDeviceMode(); - 1 !== this.getElementSettings("tenweb_parallax_on").indexOf(i) ? this.activate() : this.deactivate()
...
var posts_base = elementorModules.frontend.handlers.Base.extend({
        ...
        fitImage(e) {
            var t = this.getSettings(),
                i = e.find(t.selectors.postThumbnail),
                s = i.find("img")[0];
            if (s) {
                var n = i.outerHeight() / i.outerWidth(),
                    o = s.naturalHeight / s.naturalWidth;
                i.toggleClass(t.classes.fitHeight, o < n)
            }
        },
        fitImages() {
            var e = jQuery,
                t = this,
                i = getComputedStyle(this.$element[0], ":after").content,
                s = this.getSettings();
            this.elements.$postsContainer.toggleClass(s.classes.hasItemRatio, !!i.match(/\d/)), t.isMasonryEnabled() || this.elements.$posts.each((function() {
                var i = e(this),
                    n = i.find(s.selectors.postThumbnailImage);
                t.fitImage(i), n.on("load", (function() {
                    t.fitImage(i)
                }))
            }))
        },
        setColsCountSettings() {
            ...
            switch (t) {
                case "mobile":
                    e = i[s + "columns_mobile"];
                    break;
                case "tablet":
                    e = i[s + "columns_tablet"];
                    break;
                default:
                    e = i[s + "columns"]
            }
        ...
        runMasonry() {
            ...
            var t = this.getSettings("colsCount"),
                i = this.isMasonryEnabled() && t >= 2;
            if (e.$postsContainer.toggleClass("elementor-posts-masonry", i), i) {
    ...
    portfolio = posts_base.extend({
        ...
        getOffset(e, t, i) {
            var s = this.getSettings(),
                n = this.elements.$postsContainer.width() / s.colsCount - t;
            return {
                start: (t + (n += n / (s.colsCount - 1))) * (e % s.colsCount),
                top: (i + n) * Math.floor(e / s.colsCount)
            }
        },
        getClosureMethodsNames() {
        ...
        filterItems(e) {
            var t = this.elements.$posts,
                i = this.getSettings("classes.active"),
                s = ".elementor-filter-" + e;
            "__all" !== e ? (t.not(s).removeClass(i), t.filter(s).addClass(i)) : t.addClass(i)
        },
        removeExtraGhostItems() {
            var e = this.getSettings(),
                t = this.elements.$posts.filter(":visible"),
                i = (e.colsCount - t.length % e.colsCount) % e.colsCount;
            this.elements.$postsContainer.find("." + e.classes.ghostItem).slice(i).remove()
        },
        handleEmptyColumns() {
            this.removeExtraGhostItems();
            for (var e = this.getSettings(), t = this.elements.$posts.filter(":visible"), i = this.elements.$postsContainer.find("." + e.classes.ghostItem), s = (e.colsCount - (t.length + i.length) % e.colsCount) % e.colsCount, n = 0; n < s; n++) this.elements.$postsContainer.append(jQuery("<div>", {
        ...
        arrangeGrid() {
            var e = jQuery,
                t = this,
                i = t.getSettings(),
                s = t.elements.$posts.filter("." + i.classes.active),
                n = t.elements.$posts.not("." + i.classes.active),
                ...
                d = o.outerWidth(),
                h = o.outerHeight();
            if (t.elements.$posts.css("transition-duration", i.transitionDuration + "ms"), t.showItems(l), t.isEdit && t.fitImages(), t.handleEmptyColumns(), t.isMasonryEnabled()) return t.hideItems(c), t.showItems(l), t.handleEmptyColumns(), void t.runMasonry();
            c.css({
                opacity: 0,
                transform: "scale3d(0.2, 0.2, 1)"
            }), a.each((function() {
                var i = e(this),
                    s = t.getOffset(r.index(i), d, h),
                    n = t.getOffset(o.index(i), d, h);
                s.start === n.start && s.top === n.top || (n.start -= s.start, n.top -= s.top, elementorFrontend.config.is_rtl && (n.start *= -1), i.css({
                    transitionDuration: "",
                ...
                s.each((function() {
                    var n = e(this),
                        o = t.getOffset(r.index(n), d, h),
                        a = t.getOffset(s.index(n), d, h);
                    n.css({
                        transitionDuration: i.transitionDuration + "ms"
        ...
        activeFilterButton(e) {
            var t = this.getSettings("classes.active"),
                i = this.elements.$filterButtons,
                s = i.filter('[data-filter="' + e + '"]');
            i.removeClass(t), s.addClass(t)
        },
        setFilter(e) {
...
var _circularProgress = class {
        constructor(e, t) {
            ...
            const i = 2 * this.circularCurrentProgress.r.baseVal.value * Math.PI;
            this.circularCurrentProgress.style.strokeDasharray = `${i} ${i}`, this.circularCurrentProgress.style.strokeDashoffset = i, this.elements = this.cacheElements(), this.resizeObserver = new ResizeObserver((() => {
        ...
        updateProgress(e) {
            ...
            const t = 2 * this.elements.circularCurrentProgress.r.baseVal.value * Math.PI,
                i = t - e / 100 * t;
            this.lastKnownProgress = e, this.elements.circularCurrentProgress.style.strokeDasharray = `${t} ${t}`, this.elements.circularCurrentProgress.style.strokeDashoffset = "ltr" === this.settings.direction ? -i : i, "yes" === this.settings.percentage && (this.elements.circularCurrentProgressPercentage.innerHTML = Math.round(e) + "%")
        }
        onDestroy() {
...
jQuery(window).on("elementor/frontend/init", (function() {
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            getSwiperOptions: function() {
                ...
                var n = "arrows" === e.navigation || "both" === e.navigation,
            ...
            async initSlider() {
                ...
                this.swipers.main = await new s(this.elements.$slider, this.getSwiperOptions()), this.editButtonChange(), i && (this.swipers.main.on("slideChangeTransitionStart", (function() {
            ...
            editButtonChange: function(e) {
                if (jQuery("body").hasClass("elementor-editor-active") && (elementor.getPanelView().getCurrentPageView().$el.find(".elementor-repeater-fields .elementor-edit-template").remove(), this.$element.find(".elementor-widget-container .elementor-swiper .twbb_slides-wrapper .swiper-wrapper .swiper-slide-template.swiper-slide-active").length)) {
                    var t = this.$element.find(".elementor-widget-container .elementor-swiper .twbb_slides-wrapper .swiper-wrapper .swiper-slide-template.swiper-slide-active").attr("data-template-id"),
                        i = twbb.home_url + "/wp-admin/edit.php?post_type=elementor_library&tabs_group=twbb_templates&elementor_library_type=twbb_slide",
                        s = "Add";
                    t && (i = twbb.home_url + "/wp-admin/post.php?post=" + t + "&action=elementor", s = "Edit");
                    var n = jQuery("<a />", {
                        target: "_blank",
                    ...
                    elementor.getPanelView().getCurrentPageView().$el.find(".elementor-control-template_id").after(n)
                }
            },
            onInit: function() {
    ...
    function(e) {
        var t = function(t, i) {
            var s, n, o = !1,
                ...
                u = function() {
                    ...
                    e[n.to] = n.offset, e["top" === n.to ? "bottom" : "top"] = "", s.css(e).addClass(n.classes.stickyActive)
                },
                m = function() {
                    s.css(h(s, "unsticky")).removeClass(n.classes.stickyActive)
                },
                p = function(e, t, i) {
                    var s = getComputedStyle(e[0]),
                        ...
                        r = [];
                    return "border-box" !== s.boxSizing && r.push("border", "padding"), i && r.push("margin"), r.forEach((function(e) {
                ...
                f = function() {
                    l.$spacer = s.clone().addClass(n.classes.spacer).css({
                        visibility: "hidden",
                        transition: "none",
                        animation: "none"
                    }), s.after(l.$spacer), u(), o = !0, s.trigger("sticky:stick")
                },
                b = function() {
                    m(), l.$spacer.remove(), o = !1, s.trigger("sticky:unstick")
                },
                w = function() {
                    var e = g(s),
                        t = "top" === n.to;
                    if (r) {
                        (t ? e.top.fromTop > n.offset : e.bottom.fromBottom < -n.offset) && (l.$parent.css(h(l.$parent, "childNotFollowing")), s.css(h(s, "notFollowing")), r = !1)
                    } else {
                        var i = g(l.$parent),
                            o = getComputedStyle(l.$parent[0]),
                            a = parseFloat(o[t ? "borderBottomWidth" : "borderTopWidth"]),
                            c = t ? i.bottom.fromTop - a : i.top.fromBottom + a;
                        (t ? c <= e.bottom.fromTop : c >= e.top.fromBottom) && function() {
                            d(l.$parent, "childNotFollowing", ["position"]), l.$parent.css("position", "relative"), d(s, "notFollowing", ["position", "top", "bottom"]);
                            var e = {
                                position: "absolute"
                            };
                            e[n.to] = "", e["top" === n.to ? "bottom" : "top"] = 0, s.css(e), r = !0
                        }()
                    }
                },
                v = function() {
                    ...
                    if (o) {
                        var i = g(l.$spacer);
                        e = "top" === n.to ? i.top.fromTop - t : -i.bottom.fromBottom - t, n.parent && w(), e > 0 && b()
                    } else {
                        var r = g(s);
                        (e = "top" === n.to ? r.top.fromTop - t : -r.bottom.fromBottom - t) <= 0 && (f(), n.parent && w())
                    }! function(e) {
                        a && -e < n.effectsOffset ? (s.removeClass(n.classes.stickyEffects), a = !1) : !a && -e >= n.effectsOffset && (s.addClass(n.classes.stickyEffects), a = !0)
                    }(e)
                },
                y = function() {
                    v()
                ...
                _ = function() {
                    o && (m(), u(), n.parent && (r = !1, w()))
                };
            this.destroy = function() {
                o && b(), l.$window.off("scroll", y).off("resize", _), s.removeClass(n.classes.sticky)
            }, n = jQuery.extend(!0, c, i), s = e(t).addClass(n.classes.sticky), l.$window = e(window), n.parent && (l.$parent = s.parent(), "parent" !== n.parent && (l.$parent = l.$parent.closest(n.parent))), l.$window.on({
                scroll: y,
                resize: _
            }), v()
        };
        e.fn.sticky = function(i) {
            ...
            return this.each((function() {
                ...
                if (s) {
                    var o = n.data("sticky");
                    if (!o) throw Error("Trying to perform the `" + i + "` method prior to initialization");
                    if (!o[i]) throw ReferenceError("Method `" + i + "` not found in sticky instance");
                    o[i].apply(o, Array.prototype.slice.call(arguments, 1)), "destroy" === i && n.removeData("sticky")
                } else n.data("sticky", new t(this, i))
            })), this
        }, window.Sticky = t
    }(jQuery), jQuery(window).on("elementor/frontend/init", (function() {
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            isStickyInstanceActive: function() {
                return void 0 !== this.$element.data("tenweb_sticky")
            },
            ...
            getConfig: function() {
                ...
                return e.tenweb_sticky_parent && (t.parent = ".e-container, .elementor-widget-wrap"), i.length && "top" === e.tenweb_sticky && "fixed" === i.css("position") && (t.offset += i.height()), t
            },
            activate: function() {
        ...
        function i(e, t) {
            var i = "slides_per_view" + ("desktop" === e ? "" : "_" + e);
            return Math.min(t.slides_count, +t[i] || t.slidesPerView[e])
        }

        function s(e, t) {
            var i = "space_between";
            return e && "desktop" !== e && (i += "_" + e), t.breakpoints[i].size || 0
        }
        elementorFrontend.hooks.addAction("frontend/element_ready/twbb-testimonial-carousel.default", (function() {
            jQuery(".tenweb-testimonial-carousel-swiper").each((async function(n, o) {
                var r = jQuery(o).parents(".elementor-widget-twbb-testimonial-carousel").attr("data-id");
                jQuery(o).attr("id", "tenweb-testimonial-carousel-swiper-" + r);
                var a = jQuery(o).data("settings");
                if (!jQuery.isEmptyObject(a)) {
                    ...
                    var l = {
                        ...
                        effect: "slide",
                        initialSlide: e(a),
                        slidesPerView: i("desktop", a),
                        loop: "yes" === a.loop,
                        loopedSlides: a.slides_count,
                        slidesPerGroup: t(a),
                        spaceBetween: s("", a),
                        breakpoints: {
                            1280: {
                                slidesPerView: i("desktop", a),
                                spaceBetween: s("desktop", a)
                            },
                            768: {
                                slidesPerView: i("tablet", a),
                                spaceBetween: s("tablet", a)
                            },
                            320: {
                                slidesPerView: i("mobile", a),
                                spaceBetween: s("mobile", a)
                            }
                        }
                    };
                    "yes" == a.autoplay && (l.autoplay = {
                        delay: a.autoplay_speed,
                        disableOnInteraction: !!a.pause_on_interaction
                    });
                    const n = elementorFrontend.utils.swiper;
                    await new n(jQuery("#tenweb-testimonial-carousel-swiper-" + r), l)
                }
            }))
        }))
    }));
var _baseTabs = class extends elementorModules.frontend.handlers.Base {
        ...
        activateDefaultTab(e) {
            ...
            const i = this.getEditSettings("activeItemIndex") || e || 1,
                s = {
            ...
            this.setSettings({
                showTabFn: "show",
                hideTabFn: "hide"
            }), this.changeActiveTab(i), this.setSettings(s)
        }
        handleKeyboardNavigation(e) {
            const t = e.currentTarget,
                i = jQuery(t.closest(this.getSettings("selectors").tablist)),
                s = i.find(this.getSettings("selectors").tabTitle),
                n = "vertical" === i.attr("aria-orientation");
            switch (e.key) {
                case "ArrowLeft":
                case "ArrowRight":
                    if (n) return;
        ...
        deactivateActiveTab(e) {
            const t = this.getSettings(),
                i = t.classes.active,
                s = e ? '[data-tab="' + e + '"]' : "." + i,
                n = this.elements.$tabTitles.filter(s),
                o = this.elements.$tabContents.filter(s);
            n.add(o).removeClass(i), n.attr({
                tabindex: "-1",
                "aria-selected": "false"
    ...
    _playerBase = class {
        ...
        formatDuration(e) {
            const t = new Date(1e3 * e),
                ...
                s = t.getUTCMinutes(),
                n = t.getSeconds();
            return 0 !== i ? `${i.toString()}:${s.toString().padStart(2,"0")}:${n.toString().padStart(2,"0")}` : `${s.toString()}:${n.toString().padStart(2,"0")}`
        }
    },
        ...
        create() {
            ...
            return new Promise((e => {
                this.apiProvider.onApiReady((t => {
                    ...
                    this.playerObject = new t.Player(this.playlistItem.tabContent.querySelector("div"), i), this.playerObject.addEventListener("onStateChange", (e => {
    ...
    _playerVimeo = class extends _playerBase {
        ...
        create() {
            return this.currentVideoID = this.apiProvider.getVideoIDFromURL(this.playlistItem.videoUrl), new Promise((e => {
                this.apiProvider.onApiReady((t => {
                    ...
                    this.playerObject = new t.Player(this.playlistItem.tabContent.querySelector("div"), i), this.playerObject.ready().then((() => {
                        this.isReady = !0, e()
                    }))
                }))
            }))
        ...
        async setVideoProviderData() {
            ...
            const e = await this.playerObject.getVideoId(),
                ...
                i = await t.json();
            return this.playlistItem.duration = this.formatDuration(i[0].duration), this.playlistItem.video_title = i[0].title, this.playlistItem.thumbnail = {
                url: i[0].thumbnail_medium
            }, this.playlistItem
        }
    },
    _playerHosted = class extends _playerBase {
        ...
        create() {
            return new Promise((e => {
                ...
                const i = document.createTextNode("Sorry, your browser doesn't support embedded videos."),
                    s = document.createElement("source");
                s.setAttribute("src", this.playlistItem.videoUrl), s.setAttribute("type", "video/" + this.playlistItem.videoUrl.split(".").pop()), t.appendChild(s), t.appendChild(i), this.playerObject = t, this.playlistItem.tabContent.querySelector("div").replaceWith(this.playerObject), this.playerObject.addEventListener("canplay", (() => {
                    this.isReady = !0, e()
    ...
    _eventTrigger = {
        ...
        getEventPlaylistObject(e, t) {
            const i = t || e.currentPlaylistItemIndex;
            return {
        ...
        async getEventEventObject(e, t, i, s) {
            const n = s || e.currentPlaylistItemIndex,
                o = e.playlistItemsArray[n - 1];
            return {
                type: t,
        ...
        async triggerEvent(e, t, i, s) {
            const n = new _playlistEvent({
                event: await _eventTrigger.getEventEventObject(e, t, i, s),
            ...
            jQuery("body").trigger("elementor-twbb_video-playList", n)
        }
    },
    _innerTabs = {
        toggleInnerTabs(e, t, i) {
            const s = e.currentTarget,
                n = s.querySelectorAll(".e-inner-tab-title");
            if (t.hasClass("e-inner-tab-active") || n.length < 2) return;
            ...
            })), _innerTabs.handleInnerTabsButtonsDisplay(Array.from(o), i.isCollapsible, i.innerTabsHeightLimit), (0, _eventTrigger.triggerEvent)(i, "tabOpened", "click")
        },
        handleInnerTabs(e, t) {
            const i = e.target,
                s = i.tagName;
            if (i.classList.contains("e-inner-tab-title-text")) {
                e.preventDefault();
                const s = jQuery(i).parent(".e-inner-tab-title");
                _innerTabs.toggleInnerTabs(e, s, t)
            }
            if (i.classList.contains("e-tab-mobile-title")) {
                const s = jQuery(i);
                _innerTabs.toggleInnerTabs(e, s, t)
            }
            "button" === s.toLowerCase() && _innerTabs.onTabContentButtonsClick(e, t)
        },
        handleInnerTabsButtonsDisplay(e, t, i) {
            if (!t) return;
            const s = e.filter((e => e.classList.contains("e-inner-tab-active"))),
                n = s[0].querySelector(".e-inner-tab-text > div").offsetHeight,
                o = parseInt(i.size);
            o && n > o && s[0].classList.add("show-inner-tab-buttons")
        },
        onTabContentButtonsClick(e, t) {
            const i = jQuery(e.currentTarget).find(".e-inner-tab-content").filter(".e-inner-tab-active");
            i.find("button").toggleClass("show-button"), i.toggleClass("show-full-height");
            const s = i.hasClass("show-full-height") ? "tabExpanded" : "tabCollapsed";
    ...
    _urlParams = {
        handleURLParams(e, t) {
            ...
            if (!n) return !1;
            if (n === e) {
                const i = t.find((e => s === e.dataItemId)),
                    n = i ? i.dataTab : 1;
                return n || setVideoParams(e, t, 1), n || !1
            }
        },
        setVideoParams(e, t, i) {
            const s = new URLSearchParams(location.search);
            s.set("playlist", e), s.set("video", t[i - 1].dataItemId), history.replaceState({}, "", location.pathname + "?" + s)
        }
    },
    VideoPlaylistHandler = class extends _baseTabs {
        ...
        activateInitialVideo() {
            ...
            let i = !1;
            t ? (this.currentPlaylistItemIndex = t, this.currentPlayingPlaylistItemIndex = t, i = !0) : (this.currentPlaylistItemIndex = 1, this.currentPlayingPlaylistItemIndex = 1), this.isAutoplayOnLoad && !i && (0, _urlParams.setVideoParams)(this.playlistId, this.playlistItemsArray, this.currentPlaylistItemIndex), this.handleFirstVideoActivation(e)
        }
        handleFirstVideoActivation(e) {
            ...
            const t = document.querySelector(".elementor-element-" + this.playlistId + " .e-tabs-main-area"),
                i = elementorModules.utils.Scroll.scrollObserver({
                    callback: e => {
                        e.isInViewport && (this.activateDefaultTab(this.currentPlaylistItemIndex), i.unobserve(t))
                    }
                });
            i.observe(t)
        }
            ...
            if (e.playerInstance) this.isVideoShouldBePlayed() && (1 === this.currentPlaylistItemIndex && this.elements.$imageOverlay && this.elements.$imageOverlay.remove(), this.playVideoAfterCreation(e));
                ...
                e.playerInstance = new t[e.videoType](e, this.currentPlaylistItemIndex), e.playerInstance.create().then((() => {
                    this.isVideoShouldBePlayed() && this.playVideoOnCreation(e), e.playerInstance.handleFullScreenChange((e => {
                        ...
                        let i = "click";
                        t.isAutoplayOnLoad ? (i = "onLoad", e.isAutoplayOnLoad = !1) : t.isAutoPlayNextUp && (i = "nextVideo"), (0, _eventTrigger.triggerEvent)(this, t.playerInstance.isVideoPausedLocal ? "videoResume" : "videoStart", i)
        ...
        createPlaylistItems() {
            this.playlistItemsArray = [], this.elements.$videos.each(((e, t) => {
                const i = {},
                    s = jQuery(t);
                i.videoUrl = s.attr("data-video-url"), i.videoType = s.attr("data-video-type"), i.videoTitle = s.attr("data-video-title"), i.videoDuration = s.attr("data-video-duration"), i.tabContent = t, i.dataTab = e + 1, i.dataItemId = this.getElementSettings().tabs[e]._id, this.playlistItemsArray.push(i)
...
jQuery(window).on("elementor/frontend/init", (function() {
        ...
        class e extends elementorModules.frontend.handlers.Base {
            ...
            bindEvents() {
                ...
                if (s && n) return void this.$element.find(o.toggleButton).attr("href", i);
            ...
            governDropdownHeight() {
                ...
                const i = this.$element.find(t.productList),
                ...
                const n = document.documentElement.clientHeight,
                    ...
                    a = i.height(),
                    l = n - r - o - (this.elements.$main.prop("scrollHeight") - a) - 30,
                    c = Math.max(120, l);
                i.css("max-height", c)
            }
        }
        ...
        class e extends TWBB_WooCommerce_Base {
            ...
            editorInitTabs() {
                this.elements.$allPageElements.each(((e, t) => {
                    const i = t.getAttribute("e-my-account-page");
                    let s;
                    if ("view-order" === i) s = this.elements.$viewOrderLinks.add(this.elements.$viewOrderButtons);
                    else s = this.$element.find(".woocommerce-MyAccount-navigation-link--" + i);
                    s.on("click", (() => {
                        this.currentPage = i, this.editorShowTab()
                    }))
                }))
            }
            editorShowTab() {
        ...
        class e extends elementorModules.frontend.handlers.Base {
            ...
            moveNotices() {
                ...
                let i = elementorFrontend.elements.$body.find(t.woocommerceNotices);
                if ((elementorFrontend.isEditMode() || elementorFrontend.isWPPreviewMode()) && (i = i.filter(":not(.e-notices-demo-notice)")), e && this.elements.$documentScrollToElements.stop(), this.elements.$noticesWrapper.prepend(i), this.is_ready || (this.elements.$noticesWrapper.removeClass("e-woocommerce-notices-wrapper-loading"), this.is_ready = !0), e) {
                    let e = i;
        ...
        this.MultiRange = function(e, t) {
            ...
            generateTicks() {
                var e, t = this.delta / this.settings.tickStep,
                    i = "";
                for (e = 0; e <= t; e++) i += '<div data-value="' + (+this.settings.min + this.settings.tickStep * e).toFixed(1).replace(".0", "") + '"></div>';
                return i
            },
            getRangesHTML() {
                var e, t = this,
                    i = "";
                return this.ranges.unshift(0), this.ranges[this.ranges.length - 1] <= this.settings.max && this.ranges.push(this.settings.max), (e = this.ranges).forEach((function(s, n) {
                    if (n != e.length - 1) {
                        var o = (s - t.settings.min) / t.delta * 100;
                        o < 0 && (o = 0), i += '<div data-idx="' + n + '" class="multiRange__range" style="left:' + o + '%"><div class="multiRange__handle"></div></div>', 1 == n ? jQuery(".current_min_price").html(s.toFixed(1).replace(".0", "")) : 2 == n && jQuery(".current_max_price").html(s.toFixed(1).replace(".0", ""))
                    }
                })), i
            },
            EventDispatcher: function() {
                var e = document.createTextNode("");
                this.off = e.removeEventListener.bind(e), this.on = e.addEventListener.bind(e), this.trigger = function(t, i) {
                    if (t) {
                ...
                callbacks: {
                    ...
                    onMouseMove: function(e) {
                        ...
                        var t, i = this,
                            ...
                            n = this.ranges[+this.DOM.currentSlice.dataset.idx - 1],
                            o = this.ranges[+this.DOM.currentSlice.dataset.idx + 1];
                        t = this.settings.min + this.delta / 100 * s, this.settings.step && (t = Math.round(t / this.settings.step) * this.settings.step), t < n + this.settings.minRange && (t = n + this.settings.minRange), t > o - this.settings.minRange && (t = o - this.settings.minRange), t < this.settings.min + this.settings.minRange && (t = this.settings.min + this.settings.minRange), t > this.settings.max - this.settings.minRange && (t = this.settings.max - this.settings.minRange), s = (t - this.settings.min) / this.delta * 100, window.requestAnimationFrame((function() {
                            i.DOM.currentSlice && (i.DOM.currentSlice.style.left = s + "%")
...
jQuery(".twbb_woo_price_filter").submit((function(e) {
    ...
    class e extends TWBB_WooCommerce_Base {
        ...
        handleAddedToCart(e) {
            const t = this.getSettings("selectors"),
                i = e.siblings(t.addedToCartButton),
                s = i.parents(t.loopFormContainer);
            s.children(t.addedToCartButton).remove(), s.append(i)
        }
        bindEvents() {
            super.bindEvents(...arguments), this.elements.$quantityInput.on("change", (() => {
                this.updateAddToCartButtonQuantity()
            })), elementorFrontend.elements.$body.off("added_to_cart.twbb_woocommerce-product-add-to-cart"), elementorFrontend.elements.$body.on("added_to_cart.twbb_woocommerce-product-add-to-cart", ((e, t, i, s) => {
    ...
    jQuery.ajax({
        ...
        success: function(e) {
            const t = (new DOMParser).parseFromString(e, "text/html"),
                n = jQuery(t).find('.elementor-widget-twbb_woocommerce-products[data-id="' + s + '"]').html();
            i.html(n), jQuery(".twbb_woocommerce-products-ajax-paginate .page-numbers li").on("click", (function(e) {
...
function changeProductQuantity(e) {
    let t = jQuery(e).parent().find("input.twbb-product-quantity-input").val();
...
jQuery(window).on("elementor/frontend/init", (function() {
    ...
    jQuery(".twbb_woocommerce-products-ajax-paginate .page-numbers li").on("click", (function(e) {
        e.preventDefault(), productsAjaxPagination(jQuery(this))
    })), jQuery(".elementor-widget-twbb_woocommerce-products .add_to_cart_button").on("click", (function(e) {
    ...
    class e extends TWBB_WooCommerce_Base {
        ...
        onElementChange(e) {
            ...
            for (const i of t) e.startsWith(i) && this.equalizeElementHeight(this.elements.$address);
